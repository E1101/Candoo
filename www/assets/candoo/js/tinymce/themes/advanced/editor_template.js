/**
 * $Id: editor_template_src.js 1744 2010-03-23 20:07:31Z huuphuoc $
 *
 * @author Moxiecode
...
(function(tinymce) {
	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		sizes : [10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 36, 48, 60],
		...
		init : function(ed, url) {
			...
			t.settings = s = extend({
				...
				theme_advanced_font_sizes : '10px=1,11px=2,12px=3,13px=4,14px=5,15px=6,16px=7,18px=8,20px=9,22px=10,24px=11,26px=12,28px=13,30px=14,36px=15,48px=16,60px=17',
				readonly : ed.settings.readonly
			}, ed.settings);

			// Setup default font_size_style_values
			if (!s.font_size_style_values)
				s.font_size_style_values = "10px,11px,12px,13px,14px,15px,16px,18px,20px,22px,24px,26px,28px,30px,36px,48px,60px";
