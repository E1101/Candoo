...
class cFiles_Lib_Facedetect {
    ...
    public function __construct($detection_file = 'detection.dat') {
        ...
        $path  = dirname($class->getDeclaringFile()->getFileName());
        
        $detection_file = $path.DS.$detection_file;
    ...
    public function face_detect($imgresource) {
 
        $this->canvas = $imgresource;
