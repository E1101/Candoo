...
abstract class Candoo_App_Initalize_Abstract
{
    ...
    {
        if ($module) {
            if ( ! (Candoo_Module::isCoreModule($module) || Candoo_Module::isInstalledModule($module)) ) {
    ...
    final public function getConfig()
    {
        ...
        /*
         * Core_Init as vaa config e Candoo_App raa bar migardaanim
         */
        if ($module == 'Core') {
            return Candoo_App::getConfig(); 
        }
